...
int pulsePin[numPulseSensors];                 // Pulse Sensor purple wire connected to analog pin 
  ...
  for (int i = 0; i < numPulseSensors; i++) {
    ...
    switch (i) {
      ...
      case  1:
        ...
        break;
      case  2:
        pulsePin[i] = 2;    // pulse pin Analog 1
        blinkPin[i] = 11;   // blink output for pulse 1
        fadePin[i] = 8;     // fade output for pulse 1
        break;
